...
- the versioned 3.0 `array-length-check` scheme from `@iqb/responses` 3.6.0 pins both official full-credit/residual cases and gates AND-connected rulesets, `ANY_OPEN`, `LENGTH`, sorted array comparison, automatic zero coding, and derived `SUM_SCORE` routing across memory, file, and SQLite
