...
- original system-check execution, saved-report statistics/deletion, byte-exact legacy JSON report migration, and original-compatible CSV/JSON report exports
