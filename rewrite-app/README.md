...
scroll/hide controls. Forty-seven of the 58 keys now have active monitor UI
surfaces; unresolved keys are limited to less-common booklet, unlock/code,
filter/status, and selection copy. Logo type, bytes, safe SVG content, the original 20 MiB
