...
The named `smoke:ui:verona-player-families` slice stops after executing the official Simple Player generations and the independent ABI 3.3.0 scripted-survey Player, including type-faithful API-2 response restoration after reload.
