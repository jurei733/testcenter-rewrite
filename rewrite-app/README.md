...
participant catalog from upstream `031b3313`, plus one retained
runtime key, is versioned as a 42-key compatibility contract including
original defaults and `%s` placeholders. Current login-side copy,
