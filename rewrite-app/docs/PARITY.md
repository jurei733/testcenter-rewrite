...
system-test graph is fixed to upstream commit
...
Verona 6.0.5 Player byte-for-byte. Further corpus expansion therefore requires
additional production packages or newly introduced upstream samples.
