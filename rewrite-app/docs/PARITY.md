...
| 5 | P1 | Workspace file ambiguity and batch edge cases | Keep unique dependency closure automatic, but add operator-guided selection for ambiguous legacy names and more mixed-success upload, replacement, and deletion graphs instead of guessing. |
