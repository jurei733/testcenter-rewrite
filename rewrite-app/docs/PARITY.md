...
| 4 | P0 | Interruption and recovery at production scale | Extend the now-proven complete three-Unit adaptive foreground, reload, offline outbox, Service-Worker handoff, and idempotent replay paths to longer production packages and additional interruption timings. |
