...
| 3 | P0 | Participant execution-mode completion | The six original participant modes now share an exact capability matrix and govern import, sessions, saving, restrictions, visibility, and remote commands. Participant-facing review workflows, editable adaptive state options, and fully mode-scoped study-monitor read models remain. |
