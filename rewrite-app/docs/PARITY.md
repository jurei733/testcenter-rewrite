...
`4d097a88e5cd1d84aaca0fae1181cd20ec630921` (2026-08-13) plus the complete
...
Session-Management, and Test-Controller graphs are fixed to upstream commit
`a5a6d25a72990d667300804c337cc5b500b01d2f` (2026-08-12). The complete
...
repository is represented. A fresh audit of the current upstream repository at
...
are now pinned as 18.0 documents against those same current dependencies. Each
current Test-Controller Booklet and its 26-login roster are likewise pinned
byte-for-byte as 18.0 documents and execute with the current shared Units and
Verona 6.0.5 Player. The current root Sample package now also retains its three
...
official MIT-licensed IQB ABI 3.3.0 scripted-survey, EVA 1.0.0 scripted-survey,
DAN 3.0.0 visual-assessment, STARS 0.6.19 choice-interaction, Speedtest 1.2.0 timed-choice, and Lottie 1.2.2
shared-parameter Players. ABI retains its release example
...
object-valued state all round-trip correctly. EVA additionally gates canonical
...
navigation and reload. The official Lottie release is byte-pinned while its
...
production initial bundle is now 449.07 kB raw and 113.12 kB estimated transfer,
