...
two-booklet Aspect, BookletConfig, Group-Monitoring, Session-Management, and
Test-Controller graphs are fixed to upstream commit
...
Verona 6.0.5 Player. Every current upstream `sampledata` path and every changed
member of the audited
Adaptive, Aspect, BookletConfig, Group-Monitoring, Session-Management, and
Test-Controller graphs are therefore represented; further expansion requires
additional production packages or
