...
DAN 3.0.0 and 3.1.0 visual-assessment, STARS 0.6.19 and 0.7.2 choice-interaction,
...
DAN releases use the byte-exact `G231mm.voud` definition from a pinned official
