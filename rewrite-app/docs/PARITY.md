...
| --- | --- | --- | --- |
| 1 | P0 | Production package and dependency corpus | Add further real production packages and cover the remaining rare XML lexical facets, encodings, archive layouts, and ambiguous/cross-file dependency graphs without weakening quarantine or duplicate protection. The IANA-registered Latin-6/Latin-8 aliases, Baltic IBM775 family, and strict malformed multibyte rejection are now covered through the durable-store matrix. |
