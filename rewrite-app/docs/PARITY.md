...
The rewrite now pins and imports the current 18.0 completeness cases 5–10,
header-content cases 11–14, header-visibility cases 15/16, termination-lock cases 17/18, all eight navigation-button cases 19–26, and page-return cases 27/28 plus Unit-navigation cases 29–33 in addition to its original
four-booklet package. The remaining current
variants are tracked as explicit corpus-expansion work even where their policy
keys already have runtime coverage.
