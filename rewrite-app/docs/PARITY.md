...
| 5 | P1 | Participant login protection | Valid-from/to/for now matches the original session-window behavior; participant brute-force protection is still absent. |
