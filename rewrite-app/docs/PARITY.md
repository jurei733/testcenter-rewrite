...
`94b04751abfe024eb1d354c29718f90b4740c4c6`, and the current Adaptive and
two-booklet Aspect graphs are fixed to upstream commit
`a5a6d25a72990d667300804c337cc5b500b01d2f` (2026-08-12).
...
roster. Every current upstream `sampledata` path and every changed member of the
audited Adaptive, Aspect, and BookletConfig graphs are therefore
represented; further expansion requires additional production packages or
newly introduced upstream samples.
