...
4. deepen the provider rollout model with promotion approvals, burn-in thresholds, and time-windowed rollout metrics beyond the current instant metrics plus promote workflow
